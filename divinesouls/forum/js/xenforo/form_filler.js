 ...
 */
(function(e){XenForo._FormFiller={};XenForo.FormFillerControl=function(d){var b=d.closest("form"),a=b.data("FormFiller");a||(a=new XenForo.FormFiller(b),b.data("FormFiller",a));a.addControl(d)};XenForo.FormFiller=function(d){function b(b,c){if(XenForo.hasResponseError(c))return!1;e.each(c.formValues,function(b,c){var a=d.find(b);a.length&&(a.is(":checkbox, :radio")?a.attr("checked",c).triggerHandler("click"):a.is("select, input, textarea")&&a.val(c))});b.focus()}function a(a){var c=e(a.target).data("choice")||
