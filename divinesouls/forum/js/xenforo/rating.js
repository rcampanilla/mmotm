...
click:function(b){b.preventDefault();e?e.load():g=XenForo.ajax(d.attr("action"),{rating:c(this).val()},function(a){XenForo.hasResponseError(a)||(a._redirectMessage&&XenForo.alert(a._redirectMessage,"",1E3),a.newRating&&h.text(a.newRating),a.hintText&&f.data("text",a.hintText),a.templateHtml&&(e=XenForo.createOverlay(null,a.templateHtml,{js:a.js,css:a.css,title:a.h1||a.title}).load(),e.getOverlay().find(".OverlayCloser").click(function(){e=null})));k();g=null})}});d.mouseleave(function(){g===null&&
k()})};XenForo.register("form.RatingWidget","XenForo.RatingWidget")})(jQuery,this,document);
